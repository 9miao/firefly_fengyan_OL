...
class VCharacterManager:
    ...
    def addVCharacter(self,vcharacter):
        ...
        clientId = vcharacter.getDynamicId()
        self.character_client[characterId] = vcharacter
        self.client_character[clientId] = vcharacter
    ...
    def dropVCharacterByClientId(self,clientId):
        ...
        '''
        try:
            vcharacter = self.client_character.get(clientId)
            if vcharacter:
                characterId = vcharacter.getCharacterId()
                dynamicId = vcharacter.getDynamicId()
                del self.character_client[characterId]
                del self.client_character[dynamicId]
            else:
                pass
        finally:
            pass
    ...
    def getNodeByClientId(self,dynamicId):
        ...
        '''
        vcharacter = self.client_character.get(dynamicId)
        if vcharacter:
