...
from app.scense.component.baseInfo.ItemBaseInfoComponent import ItemBaseInfoComponent
from app.scense.component.attribute.ItemAttributeComponent import ItemAttributeComponent
from app.scense.component.item.ItemMosaicComponent import ItemMosaicComponent
from app.scense.component.pack.ItemPackComponent import ItemPackComponet
...
#            #print " "
    ...
    def getItemAttributes(self):
        ...
        info['MaxHp'] = data.get('baseHpAdditional')+ mosaicMaxHp + self.attribute.extHpAdditional if data.get('baseHpAdditional')>0 else mosaicMaxHp
