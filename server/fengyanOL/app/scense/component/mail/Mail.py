...
from app.scense.netInterface.pushObjectNetInterface import pushObjectByCharacterId
from app.scense.protoFile import PromptedMessage_pb2
from app.scense.protoFile.mail import NewMailInfoShow506_pb2
...
class Mail(object):
    ...
    def formatMailInfo(self):
        ...
        data['sendTime'] = info['sendTime']   #邮件的发送时间
    ...
    def mailIntoDB(self):
        ...
        pushMailArrived(self._receiverId)
        return result
