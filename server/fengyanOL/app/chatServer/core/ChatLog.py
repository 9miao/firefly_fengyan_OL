...
@author: SIOP_09
'''
from app.chatServer.utils.dbopera import dbFriendTop 
...
class ChatLog():
    ...
    def zxListxxList(self):
        '''获取最近联系人中在线列表和不在线列表'''
        from app.chatServer.core.PlayersManager import PlayersManager
        zxList=[] #在线最近联系人列表
        xxList=[] #下线最近联系人列表
    ...
    def addReaderList(self,id):
        ...
        '''
        from app.chatServer.netInterface import pushObjectNetInterface
