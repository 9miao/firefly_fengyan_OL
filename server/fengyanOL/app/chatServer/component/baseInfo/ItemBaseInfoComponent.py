...
@author: sean_lan
'''
from app.chatServer.component.baseInfo.BaseInfoComponent import BaseInfoComponent
import copy
...
class ItemBaseInfoComponent(BaseInfoComponent):
    ...
    def itemtemplateInfo(self):
        return dbaccess.all_ItemTemplate[self.itemTemplateId]
    ...
    def getItemTemplateInfo(self):
        ...
        if self.itemTemplateId!= -1 and self.itemTemplateId!=0:
            ...
            data = copy.deepcopy(dbaccess.all_ItemTemplate[self.itemTemplateId])
        return data
